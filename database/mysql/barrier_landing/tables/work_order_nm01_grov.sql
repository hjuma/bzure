...
-- Dumping structure for table barrier_landing.work_order_nm01_grov
CREATE TABLE IF NOT EXISTS `work_order_nm01_grov` (
  `facility_code` varchar(4) NOT NULL DEFAULT 'GROV',
...
-- Dumping data for table barrier_landing.work_order_nm01_grov: ~270 rows (approximately)
/*!40000 ALTER TABLE `work_order_nm01_grov` DISABLE KEYS */;
/*!40000 ALTER TABLE `work_order_nm01_grov` ENABLE KEYS */;
