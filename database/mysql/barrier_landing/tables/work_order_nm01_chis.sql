...
-- Dumping structure for table barrier_landing.work_order_nm01_chis
CREATE TABLE IF NOT EXISTS `work_order_nm01_chis` (
  `facility_code` varchar(4) NOT NULL DEFAULT 'CHIS',
...
-- Dumping data for table barrier_landing.work_order_nm01_chis: ~481 rows (approximately)
