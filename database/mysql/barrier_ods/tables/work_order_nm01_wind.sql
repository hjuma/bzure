...
-- Dumping structure for table barrier_ods.work_order_nm01_wind
CREATE TABLE IF NOT EXISTS `work_order_nm01_wind` (
  `BarrierSk` int(11) NOT NULL AUTO_INCREMENT,
  `facility_code` varchar(4) NOT NULL DEFAULT 'WIND',
  ...
  `source_extracted_dt` datetime NOT NULL,
  PRIMARY KEY (`BarrierSk`),
  KEY `order_wind` (`order`,`current_flag`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table barrier_ods.work_order_nm01_wind: ~0 rows (approximately)
/*!40000 ALTER TABLE `work_order_nm01_wind` DISABLE KEYS */;
/*!40000 ALTER TABLE `work_order_nm01_wind` ENABLE KEYS */;
