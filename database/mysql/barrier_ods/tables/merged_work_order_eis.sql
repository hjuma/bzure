...
-- Dumping structure for table barrier_ods.merged_work_order_eis
CREATE TABLE IF NOT EXISTS `merged_work_order_eis` (
...
-- Dumping data for table barrier_ods.merged_work_order_eis: ~0 rows (approximately)
/*!40000 ALTER TABLE `merged_work_order_eis` DISABLE KEYS */;
/*!40000 ALTER TABLE `merged_work_order_eis` ENABLE KEYS */;
