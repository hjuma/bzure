...
-- Dumping structure for table barrier_ods.work_order_nm01_mst1
CREATE TABLE IF NOT EXISTS `work_order_nm01_mst1` (
  `BarrierSk` int(11) NOT NULL AUTO_INCREMENT,
  `facility_code` varchar(4) NOT NULL DEFAULT 'MST1',
  ...
  `source_extracted_dt` datetime NOT NULL,
  PRIMARY KEY (`BarrierSk`),
  KEY `order_mst1` (`order`,`current_flag`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table barrier_ods.work_order_nm01_mst1: ~0 rows (approximately)
/*!40000 ALTER TABLE `work_order_nm01_mst1` DISABLE KEYS */;
/*!40000 ALTER TABLE `work_order_nm01_mst1` ENABLE KEYS */;
