...
-- Dumping structure for table barrier_ods.work_order_nm01_stam
CREATE TABLE IF NOT EXISTS `work_order_nm01_stam` (
  `BarrierSk` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `source_extracted_dt` datetime NOT NULL,
  PRIMARY KEY (`BarrierSk`),
  KEY `order_stam` (`order`,`current_flag`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table barrier_ods.work_order_nm01_stam: ~0 rows (approximately)
/*!40000 ALTER TABLE `work_order_nm01_stam` DISABLE KEYS */;
/*!40000 ALTER TABLE `work_order_nm01_stam` ENABLE KEYS */;
