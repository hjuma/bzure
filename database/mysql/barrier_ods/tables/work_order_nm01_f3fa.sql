...
-- Dumping structure for table barrier_ods.work_order_nm01_f3fa
CREATE TABLE IF NOT EXISTS `work_order_nm01_f3fa` (
  ...
  `source_extracted_dt` datetime NOT NULL,
  PRIMARY KEY (`BarrierSk`),
  KEY `order_f3fa` (`order`,`current_flag`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Dumping data for table barrier_ods.work_order_nm01_f3fa: ~0 rows (approximately)
